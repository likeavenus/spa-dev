...
export default class Android extends Component {
    render() {
        return (
            <svg className={this.props.styles} width="17.861" height="21.108" viewBox="0 0 17.861 21.108">
                <g id="android">
                    <g id="Group_34" data-name="Group 34">
                        <path id="Path_50"
                              ...
                              className="cls-1" data-name="Path 50" transform="translate(-36.539 -147.047)"/>
                        <path id="Path_51"
                              ...
                              className="cls-1" data-name="Path 51" transform="translate(-103.386 -152.23)"/>
                        <path id="Path_52"
                              ...
                              className="cls-1" data-name="Path 52" transform="translate(-102.29 .001)"/>
                        <path id="Path_53"
                              ...
                              className="cls-1" data-name="Path 53" transform="translate(-364.744 -147.047)"/>
                    </g>
                </g>
            </svg>
        );
